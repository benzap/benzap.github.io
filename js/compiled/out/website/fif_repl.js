 ...
 */
website.fif_repl.prepl_output_fn = (function website$fif_repl$prepl_output_fn(fif_state,p__41441){
...
var tag = cljs.core.get.call(null,map__41442__$1,new cljs.core.Keyword(null,"tag","tag",-1290361223));
var value = cljs.core.get.call(null,map__41442__$1,new cljs.core.Keyword(null,"value","value",305978217));
return cljs.core.swap_BANG_.call(null,fif_state,cljs.core.update,new cljs.core.Keyword(null,"output-string","output-string",-1945250064),((function (map__41442,map__41442__$1,tag,value){
return (function (p1__41439_SHARP_,p2__41440_SHARP_){
return cljs.core.reduce.call(null,cljs.core.str,p1__41439_SHARP_,p2__41440_SHARP_);
});})(map__41442,map__41442__$1,tag,value))
,value);
});
/**
...
var temp__5457__auto___41444 = dom_node.querySelector("textarea");
if(cljs.core.truth_(temp__5457__auto___41444)){
var textarea_41445 = temp__5457__auto___41444;
textarea_41445.addEventListener("input",((function (textarea_41445,temp__5457__auto___41444,comp,dom_node,fif_state){
return (function (e){
cljs.core.swap_BANG_.call(null,fif_state,cljs.core.assoc,new cljs.core.Keyword(null,"input-string","input-string",-1281740233),textarea_41445.value);

return website.fif_repl.evaluate_sm_fcn.call(null,fif_state);
});})(textarea_41445,temp__5457__auto___41444,comp,dom_node,fif_state))
);
} else {
}
...
var map__41446 = rum.core.react.call(null,app_state);
...
var input_string = cljs.core.get.call(null,map__41446__$1,new cljs.core.Keyword(null,"input-string","input-string",-1281740233));
var output_string = cljs.core.get.call(null,map__41446__$1,new cljs.core.Keyword(null,"output-string","output-string",-1945250064));
var output_stack = cljs.core.get.call(null,map__41446__$1,new cljs.core.Keyword(null,"output-stack","output-stack",333652409));
return React.createElement("div",({"className": "fif-repl-component"}),sablono.interpreter.create_element.call(null,"textarea",({"spellCheck": false, "defaultValue": input_string})),(function (){var attrs41448 = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(output_stack)].join('');
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs41448))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["output-stack"], null)], null),attrs41448)):({"className": "output-stack"})),((cljs.core.map_QMARK_.call(null,attrs41448))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs41448)], null)));
})(),(function (){var attrs41449 = output_string;
return cljs.core.apply.call(null,React.createElement,"div",((cljs.core.map_QMARK_.call(null,attrs41449))?sablono.interpreter.attributes.call(null,sablono.normalize.merge_with_class.call(null,new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"class","class",-2030961996),new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, ["output-string"], null)], null),attrs41449)):({"className": "output-string"})),((cljs.core.map_QMARK_.call(null,attrs41449))?null:new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [sablono.interpreter.interpret.call(null,attrs41449)], null)));
})());
...
var seq__41450 = cljs.core.seq.call(null,cljs.core.range.call(null,elems.length));
var chunk__41451 = null;
var count__41452 = (0);
var i__41453 = (0);
while(true){
if((i__41453 < count__41452)){
var elem_idx = cljs.core._nth.call(null,chunk__41451,i__41453);
var elem_41454 = (elems[elem_idx]);
website.fif_repl.mount_fif_repl.call(null,elem_41454);


var G__41455 = seq__41450;
var G__41456 = chunk__41451;
var G__41457 = count__41452;
var G__41458 = (i__41453 + (1));
seq__41450 = G__41455;
chunk__41451 = G__41456;
count__41452 = G__41457;
i__41453 = G__41458;
continue;
} else {
var temp__5457__auto__ = cljs.core.seq.call(null,seq__41450);
if(temp__5457__auto__){
var seq__41450__$1 = temp__5457__auto__;
if(cljs.core.chunked_seq_QMARK_.call(null,seq__41450__$1)){
var c__4319__auto__ = cljs.core.chunk_first.call(null,seq__41450__$1);
var G__41459 = cljs.core.chunk_rest.call(null,seq__41450__$1);
var G__41460 = c__4319__auto__;
var G__41461 = cljs.core.count.call(null,c__4319__auto__);
var G__41462 = (0);
seq__41450 = G__41459;
chunk__41451 = G__41460;
count__41452 = G__41461;
i__41453 = G__41462;
continue;
} else {
var elem_idx = cljs.core.first.call(null,seq__41450__$1);
var elem_41463 = (elems[elem_idx]);
website.fif_repl.mount_fif_repl.call(null,elem_41463);


var G__41464 = cljs.core.next.call(null,seq__41450__$1);
var G__41465 = null;
var G__41466 = (0);
var G__41467 = (0);
seq__41450 = G__41464;
chunk__41451 = G__41465;
count__41452 = G__41466;
i__41453 = G__41467;
continue;
}
} else {
