...
fif.stdlib.variable.variable_mode = (function (){var method_table__4613__auto__ = cljs.core.atom.call(null,cljs.core.PersistentArrayMap.EMPTY);
...
var vec__38382 = fif.stack_machine.get_stack.call(null,sm);
var val = cljs.core.nth.call(null,vec__38382,(0),null);
var sym = cljs.core.nth.call(null,vec__38382,(1),null);
...
var vec__38385 = fif.stack_machine.get_stack.call(null,sm);
var val = cljs.core.nth.call(null,vec__38385,(0),null);
var sym = cljs.core.nth.call(null,vec__38385,(1),null);
if((!((sym instanceof cljs.core.Symbol)))){
return fif.stack_machine.exceptions.raise_validation_error.call(null,sm,(1),sym,"Variable name must be a symbol");
} else {
if(cljs.core.contains_QMARK_.call(null,fif.stdlib.reserved._STAR_reserved_tokens_STAR_,sym)){
