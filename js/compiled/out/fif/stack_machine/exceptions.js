...
var errmsg = ["Unbounded mode argument"].join('');
...
var errmsg = ["Max Execution Step Exceeded"].join('');
...
var word_name = cljs.core.first.call(null,fif.stack_machine.get_code.call(null,sm));
var errmsg = ["Not enough values on the main stack to satisfy word function"].join('');
...
var errmsg = ["Stack Operation Validation Error"].join('');
...
var errmsg = ["Reserved Word Redefinition Error"].join('');
