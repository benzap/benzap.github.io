...
var G__38012 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__38012;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__38013 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__38013,ch);
...
if(("\\" === ch__$1)){
var ch_38014__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_38014__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_38014__$2);
} else {
}

var G__38015 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__38015;
continue;
}
}
...
var vec__38023 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__38023,(0),null);
var start_column = cljs.core.nth.call(null,vec__38023,(1),null);
...
var G__38026 = cljs.core.conj_BANG_.call(null,a,form);
a = G__38026;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__38027 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__38028 = true;
cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__38028;

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__38027;
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__38029 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__38029,(0),null);
var start_column = cljs.core.nth.call(null,vec__38029,(1),null);
...
var vec__38032 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__38032,(0),null);
var end_column = cljs.core.nth.call(null,vec__38032,(1),null);
...
var vec__38035 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__38035,(0),null);
var start_column = cljs.core.nth.call(null,vec__38035,(1),null);
...
var vec__38038 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__38038,(0),null);
var end_column = cljs.core.nth.call(null,vec__38038,(1),null);
...
var vec__38041 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__38041,(0),null);
var start_column = cljs.core.nth.call(null,vec__38041,(1),null);
...
var vec__38044 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__38044,(0),null);
var end_column = cljs.core.nth.call(null,vec__38044,(1),null);
...
var sb = (function (){var G__38047 = (new goog.string.StringBuffer());
G__38047.append(initch);
...
var G__38049 = (function (){var G__38048 = sb;
G__38048.append(ch);

return G__38048;
})();
var G__38050 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__38049;
ch = G__38050;
continue;
}
...
switch (G__38053) {
case "\\":
var G__38057 = (function (){var G__38054 = sb;
G__38054.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__38054;
})();
var G__38058 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__38057;
ch = G__38058;
continue;
...
break;
default:
var G__38059 = (function (){var G__38055 = sb;
G__38055.append(ch);

return G__38055;
})();
var G__38060 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__38059;
ch = G__38060;
continue;
...
var vec__38061 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__38061,(0),null);
var end_column = cljs.core.nth.call(null,vec__38061,(1),null);
...
var vec__38064 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__38064,(0),null);
var column = cljs.core.nth.call(null,vec__38064,(1),null);
...
var vec__38069 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__38069,(0),null);
var column = cljs.core.nth.call(null,vec__38069,(1),null);
...
var vec__38074 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__38074,(0),null);
var column = cljs.core.nth.call(null,vec__38074,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__38079 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__38079,(0),null);
var start_column = cljs.core.nth.call(null,vec__38079,(1),null);
...
var vec__38082 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__38082,(0),null);
var end_column = cljs.core.nth.call(null,vec__38082,(1),null);
...
var G__38085 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__38085,true,null,opts,pending_forms);
...
var G__38086 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__38086)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__38086)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__38086)){
...
var _STAR_suppress_read_STAR__orig_val__38087 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__38088 = true;
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__38088;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__38087;
}});
...
var G__38089 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__38089,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__38089,rdr,first_line);
...
var G__38093 = matched;
var G__38094 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__38093;
finished = G__38094;
continue;
} else {
...
var _STAR_suppress_read_STAR__orig_val__38095 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__38096 = (function (){var or__4131__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__38096;
...
}finally {cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__38095;
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__38097 = cljs.tools.reader.arg_env;
var arg_env_temp_val__38098 = cljs.core.sorted_map.call(null);
cljs.tools.reader.arg_env = arg_env_temp_val__38098;

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__38099 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__38099,"(");
...
var G__38100 = (i + (1));
var G__38101 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4131__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4131__auto__)){
return or__4131__auto__;
} else {
...
}finally {cljs.tools.reader.arg_env = arg_env_orig_val__38097;
}});
/**
...
var ch = temp__5718__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__38102 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__38102);
...
var G__38103 = cljs.core.next.call(null,s__$1);
var G__38104 = ret;
s__$1 = G__38103;
r = G__38104;
continue;
...
var G__38105 = cljs.core.next.call(null,s);
var G__38106 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__38105;
key_vals = G__38106;
continue;
} else {
...
var gensym_env_orig_val__38110 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__38111 = cljs.core.PersistentArrayMap.EMPTY;
cljs.tools.reader.gensym_env = gensym_env_temp_val__38111;
...
}finally {cljs.tools.reader.gensym_env = gensym_env_orig_val__38110;
}});
...
var temp__5718__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__38112 = token;
var G__38112__$1 = (((G__38112 == null))?null:cljs.core.subs.call(null,G__38112,(1)));
var G__38112__$2 = (((G__38112__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__38112__$1));
var G__38112__$3 = (((G__38112__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__38112__$2));
var G__38112__$4 = (((G__38112__$3 == null))?null:cljs.core.symbol.call(null,G__38112__$3));
if((G__38112__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__38112__$4);
}
})():(function (){var G__38113 = token;
var G__38113__$1 = (((G__38113 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__38113));
if((G__38113__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__38113__$1);
}
})()
));
if(cljs.core.truth_(temp__5718__auto__)){
...
}catch (e38120){if((e38120 instanceof Error)){
var e = e38120;
...
cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__38124,reader){
...
var opts = map__38125__$1;
var eof = cljs.core.get.call(null,map__38125__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
var len__4730__auto___38133 = arguments.length;
var i__4731__auto___38134 = (0);
while(true){
if((i__4731__auto___38134 < len__4730__auto___38133)){
args__4736__auto__.push((arguments[i__4731__auto___38134]));

var G__38135 = (i__4731__auto___38134 + (1));
i__4731__auto___38134 = G__38135;
continue;
} else {
}
break;
...
/** @this {Function} */
cljs.tools.reader.read_PLUS_string.cljs$lang$applyTo = (function (seq38131){
var G__38132 = cljs.core.first.call(null,seq38131);
var seq38131__$1 = cljs.core.next.call(null,seq38131);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__38132,seq38131__$1);
});
