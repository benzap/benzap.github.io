...
return cljs.core.into.call(null,cljs.core.PersistentArrayMap.EMPTY,cljs.core.remove.call(null,(function (p__35407){
var vec__35408 = p__35407;
var _ = cljs.core.nth.call(null,vec__35408,(0),null);
...
if(((((cljs.core.set_QMARK_.call(null,class$)) || (cljs.core.sequential_QMARK_.call(null,class$)))) && (cljs.core.every_QMARK_.call(null,(function (p1__35411_SHARP_){
return (((p1__35411_SHARP_ instanceof cljs.core.Keyword)) || (typeof p1__35411_SHARP_ === 'string'));
}),class$)))){
...
return cljs.core.update_in.call(null,G__35412,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"class","class",-2030961996)], null),sablono.normalize.class$);
} else {
return G__35412;
}
});
...
var G__35414 = cljs.core.reduce.call(null,cljs.core.into,cljs.core.PersistentArrayMap.EMPTY,maps__$1);
if((!(cljs.core.empty_QMARK_.call(null,classes)))){
return cljs.core.assoc.call(null,G__35414,new cljs.core.Keyword(null,"class","class",-2030961996),cljs.core.vec.call(null,classes));
} else {
return G__35414;
}
} else {
...
/** @this {Function} */
sablono.normalize.merge_with_class.cljs$lang$applyTo = (function (seq35413){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq35413));
});
...
var tag_name = cljs.core.nth.call(null,vec__35420,(0),null);
var names = cljs.core.nth.call(null,vec__35420,(1),null);
return new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [tag_name,sablono.normalize.strip_css.call(null,cljs.core.some.call(null,((function (matches,vec__35420,tag_name,names){
return (function (p1__35418_SHARP_){
if(cljs.core._EQ_.call(null,"#",cljs.core.first.call(null,p1__35418_SHARP_))){
return p1__35418_SHARP_;
} else {
return null;
}
});})(matches,vec__35420,tag_name,names))
,names)),cljs.core.into.call(null,cljs.core.PersistentVector.EMPTY,cljs.core.comp.call(null,cljs.core.filter.call(null,((function (matches,vec__35420,tag_name,names){
return (function (p1__35419_SHARP_){
return cljs.core._EQ_.call(null,".",cljs.core.first.call(null,p1__35419_SHARP_));
});})(matches,vec__35420,tag_name,names))
 ...
 */
sablono.normalize.element = (function sablono$normalize$element(p__35423){
...
var tag = first__35426;
var content = seq__35425__$1;
...
var vec__35427 = sablono.normalize.match_tag.call(null,tag);
var tag__$1 = cljs.core.nth.call(null,vec__35427,(0),null);
var id = cljs.core.nth.call(null,vec__35427,(1),null);
var class$ = cljs.core.nth.call(null,vec__35427,(2),null);
